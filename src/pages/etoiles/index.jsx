...
export default function SoleilIndex(props) {
  ...
  useEffect(() => {
    const cardChanged = compteActuel?.favorites?.find(
      (fav) => fav.favdata.nom === bouton.current?.id
    );
    if (cardChanged) {
      setIsChecked(true);
    } else {
  ...
  const handleChange = (event) => {
    const updatedAccount = {
      ...compteActuel,
      favorites: [
        ...compteActuel.favorites,
        { favdata: { url: router.asPath, nom: props.data.name } },
      ],
    };
  ...
  return (
    <>
      <Head>
        ...
        <title>La carte du Soleil</title>
      </Head>
      <section>
        <Container>
          ...
          <p className="p-sec-soleil">
            ...
            numérique. En tant que propriétaire de cette carte NFT, vous aurez
            non seulement un accès exclusif à cette œuvre d&apos;art, mais vous
            serez également l&apos;un des seuls à posséder une partie de
          ...
          {unveilingState ? (
            <>
              ...
              <div
                className={
                  "my-3 soleil-wrapper" + (unveilingState ? " rotate" : "")
                }
              >
                <Card className={"text-center legendary soleil"}>
                  ...
                  <Card.Body className="pt-1 pb-4">
                    <Card.Text>
                      Le soleil, astre de feu, source de vie et de lumière,
                      règne en maître dans notre système solaire. Il brille de
                      mille feux, réchauffant les cœurs et éclairant les
                      esprits. Tel un joyau céleste, il illumine notre univers
                      et guide nos pas sur le chemin de la découverte.
                    </Card.Text>
                  ...
                  <Card.Footer className="text-white flex items-center justify-between py-4">
                    ...
                    <div className="flex items-center justify-center gap-3">
                      ...
                      <small>
                        {(
                          props.dataEth.data[0].quote.EUR.price.toFixed(2) *
                          price
                        ).toFixed(2)}{" "}
                        &euro;
                      </small>
